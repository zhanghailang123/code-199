...
SENIOR_SOFT_EXAM_PROMPT = """����һλ�������Ϣϵͳ��Ŀ����ʦ�������߼���ר�Ҽ��ľ��鳤��
���Ŀ���ǰ�������**ͨ������**��������Ŀ����֪ʶ��ϵ��PMBOK������Ϣϵͳ�ۺ�֪ʶ��

��Ŀ���ݣ�
{question_text}

�밴������JSON��ʽ���ط��������ȷ�����ص��ǺϷ���JSON����
...
{{
    ...
    "options": "ѡ���ı������У�",
    "answer": "��ȷ��",
    "explanation": "���ϸ��������ʽ���������ʹ��Markdown����\\n\\n### ?? ���㶨λ\\n���⿼�� [ʮ���������/��������/��Ϣ������] �е� [����֪ʶ��]������ [��Ƶ/����] ���㡣\\n\\n### ?? ֪ʶ�㾫��\\n**����**: [���ĸ����]\\n**�ؼ�Ҫ��**: [�磺����/���/�����뼼��]\\n**�׻����**: [��ظ���Ա�]\\n\\n### ? ����˼·\\n**Step 1**: [������ɹؼ���Ϣ]\\n**Step 2**: [�ų�����ѡ��/����������]\\n**Step 3**: [�ó�����/���ƴ�]\\n\\n### ?? ����/���� ����\\n[���ѡ���⣺�ų������ɣ���԰��������ܴ���ģ�壻������ģ�д���ܹ�������]",
    "knowledge_points": ["��Ŀ��Χ����", "�ؼ�·����", "��ֵ����", "��Ϣ��ս��"],
    "tags": ["�ۺ�֪ʶ", "��������", "����"],
    
    "case_analysis": {{
        "problems": ["����1�ؼ���", "����2�ؼ���"],
        "solution_template": "�����������ܽ��/ģ��"
    }},
